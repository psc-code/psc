...
for zl=z1+0L,z2,stepz do begin
   for xl=x1+0L,x2,stepx do begin
      ...
      if (pnum gt 0) then begin
         ...
         fo=strmid(nmfc,0,strlen(nmfc)-13)+'_ypx'$
         ...
         plot, ypl, pxpl, xs=1, ys=1, charsize=1.6, psym=3, $
...
;                 strtrim(string(pxmax),2)], $
         ...
         fo=strmid(nmfc,0,strlen(nmfc)-13)+'_ypy'$
         +'_t'+strmid(nmfc,strlen(nmfc)-13,5)$
         +'_x'+strtrim(string(xl),2)$
         +'_z'+strtrim(string(zl),2)$
         +'.eps'
...
;                 strtrim(string(pymax),2)], $
         ...
         fo=strmid(nmfc,0,strlen(nmfc)-13)+'_ypz'$
         +'_t'+strmid(nmfc,strlen(nmfc)-13,5)$
         +'_x'+strtrim(string(xl),2)$
         +'_z'+strtrim(string(zl),2)$
         +'.eps'
         ...
         plot, ypl, pzpl, xs=1, ys=1, charsize=1.6, psym=3, $
         POSITION=[x0,y0,x0+xdim,y0+ydim],/DEVICE, $ 
         xtitle='!8y/!7l!8m',$
         xticks=2,$
;         xtickn=[strtrim(string(1.e6*y(y1)),2), $
