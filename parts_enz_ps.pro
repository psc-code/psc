         ...
         if (pnum gt 0) then begin
            ...
            for j=0L,pnum-1 do begin
               ...
               if (0.0 lt ll) and (ll lt pbin-1) then begin
                  nnpl(ll)=nnpl(ll)+1.0*wnpl(j)*number
               endif else begin
                  nnpl(pbin-1)=nnpl(pbin-1)+1.0*wnpl(j)*number
               endelse
            endfor
            ...
            fo=strmid(nmfc,0,strlen(nmfc)-13)+'_enx'$
            ...
            plot, enpl(20:pbin-20), snnpl(20:pbin-20), $  	; hier passiert was !
...
;                    strtrim(string(enmax),2)], $
            ...
            fo=strmid(nmfc,0,strlen(nmfc)-13)+'_eny'$
            +'_m'+strtrim(string(mass(ml)),2)$
            +'_t'+strmid(nmfc,strlen(nmfc)-13,5)$
            +'_x'+strtrim(string(xl),2)$
            +'_y'+strtrim(string(yl),2)$
...
;                    strtrim(string(enmax),2)], $
            ...
            fo=strmid(nmfc,0,strlen(nmfc)-13)+'_enz'$
            +'_m'+strtrim(string(mass(ml)),2)$
            +'_t'+strmid(nmfc,strlen(nmfc)-13,5)$
            +'_x'+strtrim(string(xl),2)$
            +'_y'+strtrim(string(yl),2)$
