...
primbb_c(struct ggcm_mhd *mhd)
{
  ...
  mrc_fld_foreach(f, ix,iy,iz, 1, 2) {
    MRC_F3(f,_BX, ix,iy,iz) = .5f*(MRC_F3(f,_B1X, ix,iy,iz) +
				   MRC_F3(f,_B1X, ix-1,iy,iz));
    MRC_F3(f,_BY, ix,iy,iz) = .5f*(MRC_F3(f,_B1Y, ix,iy,iz) +
				   MRC_F3(f,_B1Y, ix,iy-1,iz));
    MRC_F3(f,_BZ, ix,iy,iz) = .5f*(MRC_F3(f,_B1Z, ix,iy,iz) +
