	 ...
	 struct mrc_fld *prim)
{
  mrc_fld_foreach(tmp, ix,iy,iz, 2, 2) {
    ...
    F3(tmp, 0, ix,iy,iz) = a * F3(prim, _VX, ix,iy,iz);
    F3(tmp, 1, ix,iy,iz) = a * F3(prim, _VY, ix,iy,iz);
    F3(tmp, 2, ix,iy,iz) = a * F3(prim, _VZ, ix,iy,iz);
  } mrc_fld_foreach_end;
}
	 ...
	 struct mrc_fld *prim)
{
  ...
  mrc_fld_foreach(tmp, ix,iy,iz, 2, 2) {
    ...
    F3(tmp, 0, ix,iy,iz) = ep * F3(prim, _VX, ix,iy,iz);
    F3(tmp, 1, ix,iy,iz) = ep * F3(prim, _VY, ix,iy,iz);
    F3(tmp, 2, ix,iy,iz) = ep * F3(prim, _VZ, ix,iy,iz);
  } mrc_fld_foreach_end;
}
	...
	struct mrc_fld *x, int m, struct mrc_fld *prim)
{
  mrc_fld_foreach(flux, ix,iy,iz, 1, 0) {
    ...
    F3(flux, 0, ix,iy,iz) =
      .5f * ((F3(tmp, 0, ix  ,iy,iz) + F3(tmp, 0, ix+1,iy,iz)) -
	     .5f * (F3(prim, _CMSV, ix+1,iy,iz) + cmsv) * (F3(x, m, ix+1,iy,iz) - aa));
    F3(flux, 1, ix,iy,iz) =
      .5f * ((F3(tmp, 1, ix,iy  ,iz) + F3(tmp, 1, ix,iy+1,iz)) -
	     .5f * (F3(prim, _CMSV, ix,iy+1,iz) + cmsv) * (F3(x, m, ix,iy+1,iz) - aa));
    F3(flux, 2, ix,iy,iz) =
      .5f * ((F3(tmp, 2, ix,iy,iz  ) + F3(tmp, 2, ix,iy,iz+1)) -
	...
	struct mrc_fld *x, int m, struct mrc_fld *prim, struct mrc_fld *c)
{
  ...
  mrc_fld_foreach(flux, ix,iy,iz, 1, 0) {
    mrc_fld_data_t fhx = (s7 * (F3(tmp, 0, ix  ,iy,iz) + F3(tmp, 0, ix+1,iy,iz)) -
			  s1 * (F3(tmp, 0, ix-1,iy,iz) + F3(tmp, 0, ix+2,iy,iz)));
    mrc_fld_data_t fhy = (s7 * (F3(tmp, 1, ix,iy  ,iz) + F3(tmp, 1, ix,iy+1,iz)) -
			  s1 * (F3(tmp, 1, ix,iy-1,iz) + F3(tmp, 1, ix,iy+2,iz)));
    mrc_fld_data_t fhz = (s7 * (F3(tmp, 2, ix,iy,iz  ) + F3(tmp, 2, ix,iy,iz+1)) -
			  s1 * (F3(tmp, 2, ix,iy,iz-1) + F3(tmp, 2, ix,iy,iz+2)));
    ...
    F3(flux, 0, ix,iy,iz) = cx * flx + (1.f - cx) * fhx;
    mrc_fld_data_t cy = F3(c, 1, ix,iy,iz);
    F3(flux, 1, ix,iy,iz) = cy * fly + (1.f - cy) * fhy;
    mrc_fld_data_t cz = F3(c, 2, ix,iy,iz);
    F3(flux, 2, ix,iy,iz) = cz * flz + (1.f - cz) * fhz;
  } mrc_fld_foreach_end;
}
	...
	struct mrc_fld *flux, mrc_fld_data_t dt)
{
  ...
  mrc_fld_foreach(x, ix,iy,iz, 0, 0) {
    ...
    F3(x, m, ix,iy,iz) +=
      - s * (fd1x[ix] * (F3(flux, 0, ix,iy,iz) - F3(flux, 0, ix-1,iy,iz)) +
	     fd1y[iy] * (F3(flux, 1, ix,iy,iz) - F3(flux, 1, ix,iy-1,iz)) +
	     fd1z[iz] * (F3(flux, 2, ix,iy,iz) - F3(flux, 2, ix,iy,iz-1)));
  } mrc_fld_foreach_end;
}
	 ...
	 struct mrc_fld *prim)
{
  ...
  mrc_fld_foreach(x, ix,iy,iz, 0, 0) {
    ...
    F3(x, _RV1X, ix,iy,iz) += z * fpx;
    F3(x, _RV1Y, ix,iy,iz) += z * fpy;
    F3(x, _RV1Z, ix,iy,iz) += z * fpz;
  } mrc_fld_foreach_end;
}
...
static void
curr_c(struct ggcm_mhd *mhd, struct mrc_fld *j, struct mrc_fld *x)
{
  ...
  mrc_fld_foreach(j, ix,iy,iz, 1, 2) {
    F3(j, 0, ix,iy,iz) =
      (F3(x, _B1Z, ix,iy,iz) - F3(x, _B1Z, ix,iy-1,iz)) * bd4y[iy] -
      (F3(x, _B1Y, ix,iy,iz) - F3(x, _B1Y, ix,iy,iz-1)) * bd4z[iz];
    F3(j, 1, ix,iy,iz) =
      (F3(x, _B1X, ix,iy,iz) - F3(x, _B1X, ix,iy,iz-1)) * bd4z[iz] -
      (F3(x, _B1Z, ix,iy,iz) - F3(x, _B1Z, ix-1,iy,iz)) * bd4x[ix];
    F3(j, 2, ix,iy,iz) =
      (F3(x, _B1Y, ix,iy,iz) - F3(x, _B1Y, ix-1,iy,iz)) * bd4x[ix] -
      (F3(x, _B1X, ix,iy,iz) - F3(x, _B1X, ix,iy-1,iz)) * bd4y[iy];
  } mrc_fld_foreach_end;
}
...
compute_B_cc(struct ggcm_mhd *mhd, struct mrc_fld *b_cc, struct mrc_fld *x)
{
  mrc_fld_foreach(b_cc, ix,iy,iz, 1, 1) {
    F3(b_cc, 0, ix,iy,iz) = .5f * (F3(x, _B1X, ix  ,iy,iz) +
				   F3(x, _B1X, ix+1,iy,iz));
    F3(b_cc, 1, ix,iy,iz) = .5f * (F3(x, _B1Y, ix,iy  ,iz) +
				   F3(x, _B1Y, ix,iy+1,iz));
    F3(b_cc, 2, ix,iy,iz) = .5f * (F3(x, _B1Z, ix,iy,iz  ) +
				   F3(x, _B1Z, ix,iy,iz+1));
  } mrc_fld_foreach_end;
}
...
{ 
  ...
  mrc_fld_foreach(j_cc, ix,iy,iz, 1, 1) {
    ...
    F3(j_cc, 0, ix,iy,iz) = s * (F3(j, 0, ix,iy+1,iz+1) + F3(j, 0, ix,iy,iz+1) +
				 F3(j, 0, ix,iy+1,iz  ) + F3(j, 0, ix,iy,iz  ));
    F3(j_cc, 1, ix,iy,iz) = s * (F3(j, 1, ix+1,iy,iz+1) + F3(j, 1, ix,iy,iz+1) +
				 F3(j, 1, ix+1,iy,iz  ) + F3(j, 1, ix,iy,iz  ));
    F3(j_cc, 2, ix,iy,iz) = s * (F3(j, 2, ix+1,iy+1,iz) + F3(j, 2, ix,iy+1,iz) +
	  ...
	  struct mrc_fld *x_next)
{
  ...
  mrc_fld_foreach(x_next, ix,iy,iz, 0, 0) {
    ...
    F3(x_next, _RV1X, ix,iy,iz) += ffx;
    F3(x_next, _RV1Y, ix,iy,iz) += ffy;
    F3(x_next, _RV1Z, ix,iy,iz) += ffz;
    F3(x_next, _UU1 , ix,iy,iz) += duu;
  } mrc_fld_foreach_end;
}
	       ...
	       int JX1, int JY1, int JZ1, int JX2, int JY2, int JZ2)
{
  ...
  mrc_fld_foreach(tmp, ix,iy,iz, 1, 2) {
    ...
    F3(tmp, 0, ix,iy,iz) = bd1[ZZ] * 
      (F3(x, _B1X + YY, ix,iy,iz) - F3(x, _B1X + YY, ix-JX2,iy-JY2,iz-JZ2));
    F3(tmp, 1, ix,iy,iz) = bd1[YY] * 
      (F3(x, _B1X + ZZ, ix,iy,iz) - F3(x, _B1X + ZZ, ix-JX1,iy-JY1,iz-JZ1));
  } mrc_fld_foreach_end;
	   ...
	   float *bd2x, float *bd2y, float *bd2z, mrc_fld_data_t dt)
{
    ...
    if (vvYY > 0.f) {
      vbZZ = F3(x, _B1X + ZZ, ix-JX1,iy-JY1,iz-JZ1) +
	F3(tmp, 3, ix-JX1,iy-JY1,iz-JZ1) * (bd2m[YY] - dt*vvYY);
    } else {
      vbZZ = F3(x, _B1X + ZZ, ix,iy,iz) -
    ...
    if (vvZZ > 0.f) {
      vbYY = F3(x, _B1X + YY, ix-JX2,iy-JY2,iz-JZ2) +
	F3(tmp, 2, ix-JX2,iy-JY2,iz-JZ2) * (bd2m[ZZ] - dt*vvZZ);
    } else {
      vbYY = F3(x, _B1X + YY, ix,iy,iz) -
	    ...
	    struct mrc_fld *E, mrc_fld_data_t dt, struct mrc_fld *x)
{
  ...
  mrc_fld_foreach(E, ix,iy,iz, 1, 0) {
    ...
    calc_v_x_B(ttmp, x, prim, tmp, ix, iy, iz, XX, YY, ZZ, IX, IY, IZ,
	       JX1, JY1, JZ1, JX2, JY2, JZ2, bd2x, bd2y, bd2z, dt);
    
    mrc_fld_data_t t1m = F3(x, _B1X + ZZ, ix+JX1,iy+JY1,iz+JZ1) - F3(x, _B1X + ZZ, ix,iy,iz);
    mrc_fld_data_t t1p = fabsf(F3(x, _B1X + ZZ, ix+JX1,iy+JY1,iz+JZ1)) + fabsf(F3(x, _B1X + ZZ, ix,iy,iz));
    mrc_fld_data_t t2m = F3(x, _B1X + YY, ix+JX2,iy+JY2,iz+JZ2) - F3(x, _B1X + YY, ix,iy,iz);
    mrc_fld_data_t t2p = fabsf(F3(x, _B1X + YY, ix+JX2,iy+JY2,iz+JZ2)) + fabsf(F3(x, _B1X + YY, ix,iy,iz));
