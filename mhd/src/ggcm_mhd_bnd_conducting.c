				...
				float bntim)
{
  ...
  if (bc[1] != BC_PERIODIC && info.off[1] == 0) { // x lo
	...
	MRC_F3(fld,_JX, ix,-2,iz) = 0.0 ;
	MRC_F3(fld,_JX, ix,-1,iz) = 0.0 ;
	MRC_F3(fld,_JX, ix, 0,iz) = 0.0 ;

	MRC_F3(fld,_JZ, ix,-2,iz) = 0.0 ;
	MRC_F3(fld,_JZ, ix,-1,iz) = 0.0 ;
	MRC_F3(fld,_JZ, ix, 0,iz) = 0.0 ;

	MRC_F3(fld,_EX, ix,-2,iz) = 0.0 ;
	MRC_F3(fld,_EX, ix,-1,iz) = 0.0 ;
	
	MRC_F3(fld,_EZ, ix,-2,iz) = 0.0 ;
	MRC_F3(fld,_EZ, ix,-1,iz) = 0.0 ;
	
	B1Y(fld, ix,-1,iz) = 0.0;
	B1Y(fld, ix, 0,iz) = 0.0;

	MRC_F3(fld,_RV1Y, ix,-2,iz) = 0.0;
	MRC_F3(fld,_RV1Y, ix,-1,iz) = 0.0;
	MRC_F3(fld,_RV1Y, ix,0,iz) = 0.0;
	MRC_F3(fld,_RV1Y, ix,1,iz) = 0.0;
 ...
 if (bc[1] != BC_PERIODIC && info.off[1] + info.ldims[1] == gdims[1]) { // x hi
	...
	MRC_F3(fld,_JX, ix,ny+1,iz) = 0.0 ;
	MRC_F3(fld,_JX, ix,ny,iz) = 0.0 ;
	MRC_F3(fld,_JX, ix,ny-1,iz) = 0.0 ;

	MRC_F3(fld,_JZ, ix,ny+1,iz) = 0.0 ;
	MRC_F3(fld,_JZ, ix,ny,iz) = 0.0 ;
	MRC_F3(fld,_JZ, ix,ny-1,iz) = 0.0 ;

	MRC_F3(fld,_EX, ix,ny+1,iz) = 0.0 ;
	MRC_F3(fld,_EX, ix,ny,iz) = 0.0 ;	
	MRC_F3(fld,_EZ, ix,ny+1,iz) = 0.0 ;
	MRC_F3(fld,_EZ, ix,ny,iz) = 0.0 ;
	...
	B1Y(fld, ix,ny+1,iz) = 0.0; 
	B1Y(fld, ix,ny,iz) = 0.0; 

	MRC_F3(fld,_RV1Y, ix,ny+1,iz) = 0.0;
	MRC_F3(fld,_RV1Y, ix,ny,iz) = 0.0; 
	MRC_F3(fld,_RV1Y, ix,ny-1,iz) = 0.0;
      }
    }
  }
