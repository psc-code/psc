...
# viscid_ts --slice x=0,y=0,z=0 -p vy -p vz -p by -p bz cpaw_x_512.3d.xdmf

# plot final time step:
# viscid_2d --own --slice z=0 -p vy -p vz -p by -p bz -t -1 cpaw_x_512.3d.xdmf

# plot movie:
# viscid_2d --own --slice z=0 -p vx -p vy -p vz -p bx -p by -p bz \
#           -a cpaw_x_512.mp4 --np 2 cpaw_x_512.3d.xdmf
