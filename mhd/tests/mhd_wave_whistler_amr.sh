...
#
# Run Notes: Circularly polarized alfven wave. This test does not look
#            good at refinement boundaries!
#
...
#           whistler_amr_16.3d.xdmf

# plot final time step:
# viscid_2d --slice z=0.0 -o p_y -p vx -p vy -p vz -p bx -p by -p bz \
#           -t -1 whistler_amr_16.3d.xdmf

# plot movie:
# viscid_2d --slice z=0.0 -o p_y -p vx -p vy -p vz -p bx -p by -p bz \
#           -a whistler_amr_16.mp4 --np 2 whistler_amr_16.3d.xdmf
