...
openmpirun -n 1 ./mhd_kh \
    --mrc_crds_lx -0.5 --mrc_crds_ly -0.5 --mrc_crds_lz -0.5 \
    --mrc_crds_hx  0.5 --mrc_crds_hy  0.5 --mrc_crds_hz  0.5 \
    --pert 1e-1 --pert_random .0 --B0 .129 \
    ...
    --ggcm_mhd_step_debug_dump false \
    --magdiffu const \
    --do_nwst \
    2>&1 | tee log
