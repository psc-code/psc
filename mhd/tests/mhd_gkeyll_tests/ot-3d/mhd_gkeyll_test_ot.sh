...
mpirun -n 4  ../../mhd_gkeyll \
    ...
    --mrc_crds_lz 0.  --mrc_crds_hz 3.14159265359 \
    --mrc_domain_mx 64 --mrc_domain_bcx periodic \
    --mrc_domain_my 64 --mrc_domain_bcy periodic \
    --mrc_domain_mz 32 --mrc_domain_bcz periodic \
