...
Grid_t* setupGrid()
{
  ...
  // 20 x 10 x 60 = 12000 = 120 procs = 20 nodes
  Grid_t::Real3 LL = {1280., 640., 3840.}; // domain size (in d_e)
  Int3 gdims = {1280, 640, 3840};         // global number of grid points
  Int3 np = {40, 20, 120};                // division into patches
  // 40 x 20 x 120 = 96,000 = 960 procs = 160 nodes
...
void run()
{
  ...
  checks_params.continuity_threshold = 1000;
  ...
  outf_params.tfield_average_every = 0;//40;
  outf_params.tfield_moments_average_every = 0;//80;
