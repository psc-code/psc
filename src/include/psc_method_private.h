...
struct psc_method_ops {
  ...
  void (*setup_fields)(struct psc_method *method, struct psc *psc);
  void (*setup_partition)(struct psc_method *method, struct psc *psc, int *n_prts_by_patch,
			  int *particle_label_offset);
  void (*setup_particles)(struct psc_method *method, struct psc *psc, int *n_prts_by_patch,
			  int particle_label_offset);
  void (*setup_partition_and_particles)(struct psc_method *method, struct psc *psc);
