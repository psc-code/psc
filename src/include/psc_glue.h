...
void PIC_push_part_xyz(struct psc* psc, int p, struct psc_particles* pp,
                       struct psc_fields* pf);
void PIC_push_part_xy(struct psc* psc, int p, struct psc_particles* pp,
                      struct psc_fields* pf);
void PIC_push_part_xz(struct psc* psc, int p, struct psc_particles* pp,
                      struct psc_fields* pf);
void PIC_push_part_yz(struct psc* psc, int p, struct psc_particles* pp,
                      struct psc_fields* pf);
void PIC_push_part_z(struct psc* psc, int p, struct psc_particles* pp,
                     struct psc_fields* pf);
void PIC_push_part_z_vay(struct psc* psc, int p, struct psc_particles* pp,
                         struct psc_fields* pf);
