...
#elif PTYPE == PTYPE_SINGLE_BY_KIND

#define particle_PTYPE_real_t particle_single_by_kind_real_t
#define particle_PTYPE_t particle_single_by_kind_t

#define psc_particle_PTYPE_buf_t psc_particle_single_by_kind_buf_t
#define psc_particle_PTYPE_buf_ctor psc_particle_single_by_kind_buf_ctor
#define psc_particle_PTYPE_buf_dtor psc_particle_single_by_kind_buf_dtor
#define psc_particle_PTYPE_buf_size psc_particle_single_by_kind_buf_size
#define psc_particle_PTYPE_buf_resize psc_particle_single_by_kind_buf_resize
#define psc_particle_PTYPE_buf_reserve psc_particle_single_by_kind_buf_reserve
#define psc_particle_PTYPE_buf_capacity psc_particle_single_by_kind_buf_capacity
#define psc_particle_PTYPE_buf_push_back psc_particle_single_by_kind_buf_push_back
#define psc_particle_PTYPE_buf_at_ptr psc_particle_single_by_kind_buf_at_ptr

#define psc_mparticles_PTYPE_patch psc_mparticles_single_by_kind_patch
#define psc_mparticles_PTYPE psc_mparticles_single_by_kind
#define psc_mparticles_PTYPE_ops psc_mparticles_single_by_kind_ops
#define psc_mparticles_PTYPE_patch_get_buf psc_mparticles_single_by_kind_patch_get_buf
#define psc_mparticles_PTYPE_get_one psc_mparticles_single_by_kind_get_one
#define psc_mparticles_PTYPE_get_n_prts psc_mparticles_single_by_kind_get_n_prts
#define psc_mparticles_PTYPE_patch_reserve psc_mparticles_single_by_kind_patch_reserve
#define psc_mparticles_PTYPE_patch_push_back psc_mparticles_single_by_kind_patch_push_back
#define psc_mparticles_PTYPE_patch_resize psc_mparticles_single_by_kind_patch_resize
#define psc_mparticles_PTYPE_patch_capacity psc_mparticles_single_by_kind_patch_capacity
#define psc_mparticles_PTYPE_patch_get_b_dxi psc_mparticles_single_by_kind_patch_get_b_dxi 
#define psc_mparticles_PTYPE_patch_get_b_mx psc_mparticles_single_by_kind_patch_get_b_mx
#define psc_particle_PTYPE_iter_t psc_particle_single_by_kind_iter_t
#define psc_particle_PTYPE_iter_equal psc_particle_single_by_kind_iter_equal
#define psc_particle_PTYPE_iter_next psc_particle_single_by_kind_iter_next 
#define psc_particle_PTYPE_iter_deref psc_particle_single_by_kind_iter_deref 
#define psc_particle_PTYPE_iter_at psc_particle_single_by_kind_iter_at 
#define psc_particle_PTYPE_range_t psc_particle_single_by_kind_range_t
#define psc_particle_PTYPE_range_mprts psc_particle_single_by_kind_range_mprts
#define psc_particle_PTYPE_range_size psc_particle_single_by_kind_range_size
