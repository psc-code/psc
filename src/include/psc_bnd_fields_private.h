...
struct psc_bnd_fields_ops {
  ...
  void (*fill_ghosts_a_E)(struct psc_bnd_fields *bnd, struct psc_fields *flds);
  void (*fill_ghosts_a_H)(struct psc_bnd_fields *bnd, struct psc_fields *flds);
  void (*fill_ghosts_b_H)(struct psc_bnd_fields *bnd, struct psc_fields *flds);
  void (*fill_ghosts_b_E)(struct psc_bnd_fields *bnd, struct psc_fields *flds);
  void (*add_ghosts_J)(struct psc_bnd_fields *bnd, struct psc_fields *flds);
};
...
extern struct psc_bnd_fields_ops psc_bnd_fields_mix_ops;
