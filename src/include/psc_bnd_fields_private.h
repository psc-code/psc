...
struct psc_bnd_fields_ops {
  ...
  void (*fill_ghosts_a_E)(struct psc_bnd_fields *bnd, struct psc_mfields *mflds);
  void (*fill_ghosts_a_H)(struct psc_bnd_fields *bnd, struct psc_mfields *mflds);
  void (*fill_ghosts_b_H)(struct psc_bnd_fields *bnd, struct psc_mfields *mflds);
  void (*fill_ghosts_b_E)(struct psc_bnd_fields *bnd, struct psc_mfields *mflds);
