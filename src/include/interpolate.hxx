...
template <typename R>
static inline void get_nint_remainder(int* lg1, R* h1, R u)
{
  int l = nint(u);
  *lg1 = l;
  *h1 = l - u;
...
struct ip_coeffs<R, opt_ip_1st_ec>
{
  ...
  __host__ __device__ void set(R xm) { g.set(xm); }
...
struct InterpolateEM_Helper<F, IP, opt_ip_1st_ec, dim_xyz>
{
  ...
  {
    return (ip.cz.g.v0 *
              (ip.cy.g.v0 * EM(EX, ip.cx.g.l, ip.cy.g.l, ip.cz.g.l) +
               ip.cy.g.v1 * EM(EX, ip.cx.g.l, ip.cy.g.l + 1, ip.cz.g.l)) +
            ip.cz.g.v1 *
              (ip.cy.g.v0 * EM(EX, ip.cx.g.l, ip.cy.g.l, ip.cz.g.l + 1) +
  ...
  {
    return (ip.cx.g.v0 *
              (ip.cz.g.v0 * EM(EY, ip.cx.g.l, ip.cy.g.l, ip.cz.g.l) +
               ip.cz.g.v1 * EM(EY, ip.cx.g.l, ip.cy.g.l, ip.cz.g.l + 1)) +
            ip.cx.g.v1 *
              (ip.cz.g.v0 * EM(EY, ip.cx.g.l + 1, ip.cy.g.l, ip.cz.g.l) +
  ...
  {
    return (ip.cy.g.v0 *
              (ip.cx.g.v0 * EM(EZ, ip.cx.g.l, ip.cy.g.l, ip.cz.g.l) +
               ip.cx.g.v1 * EM(EZ, ip.cx.g.l + 1, ip.cy.g.l, ip.cz.g.l)) +
            ip.cy.g.v1 *
              (ip.cx.g.v0 * EM(EZ, ip.cx.g.l, ip.cy.g.l + 1, ip.cz.g.l) +
...
struct InterpolateEM_Helper<F, IP, opt_ip_1st_ec, dim_yz>
{
  ...
  __host__ __device__ static real_t ex(const IP& ip, const F& EM)
  {
    return (ip.cz.g.v0 * (ip.cy.g.v0 * EM(EX, 0, ip.cy.g.l, ip.cz.g.l) +
            ...
            ip.cz.g.v1 *
              (ip.cy.g.v0 * EM(EX, 0, ip.cy.g.l, ip.cz.g.l + 1) +
...
struct InterpolateEM_Helper<F, IP, opt_ip_1st, dim_xz>
{
  ...
  static real_t cc(const ip_coeff_t& gx, const ip_coeff_t& gy,
                   const ip_coeff_t& gz, const F& EM, int m)
  {
  ...
  {
    return cc(ip.cx.h, ip.cy.g, ip.cz.g, EM, EX);
  }
  static real_t ey(const IP& ip, const F& EM)
  {
    return cc(ip.cx.g, ip.cy.h, ip.cz.g, EM, EY);
  }
  static real_t ez(const IP& ip, const F& EM)
  {
    return cc(ip.cx.g, ip.cy.g, ip.cz.h, EM, EZ);
  }
  static real_t hx(const IP& ip, const F& EM)
  {
    return cc(ip.cx.g, ip.cy.h, ip.cz.h, EM, HX);
  }
  static real_t hy(const IP& ip, const F& EM)
  {
    return cc(ip.cx.h, ip.cy.g, ip.cz.h, EM, HY);
  }
  static real_t hz(const IP& ip, const F& EM)
  {
    return cc(ip.cx.h, ip.cy.h, ip.cz.g, EM, HZ);
  }
};
...
struct InterpolateEM_Helper<F, IP, opt_ip_1st, dim_yz>
{
  ...
  __host__ __device__ static real_t cc(const ip_coeff_t& gx,
                                       const ip_coeff_t& gy,
                                       const ip_coeff_t& gz, const F& EM, int m)
  {
...
struct InterpolateEM_Helper<F, IP, opt_ip_2nd, dim_y>
{
  ...
  static real_t cc(const ip_coeff_t& gx, const ip_coeff_t& gy,
                   const ip_coeff_t& gz, F EM, int m)
  {
    return (gy.vm * EM(m, 0, gy.l - 1, 0) + gy.v0 * EM(m, 0, gy.l, 0) +
...
struct InterpolateEM_Helper<F, IP, opt_ip_2nd, dim_z>
{
  ...
  static real_t cc(const ip_coeff_t& gx, const ip_coeff_t& gy,
                   const ip_coeff_t& gz, F EM, int m)
  {
    return (gz.vm * EM(m, 0, 0, gz.l - 1) + gz.v0 * EM(m, 0, 0, gz.l) +
...
struct InterpolateEM_Helper<F, IP, opt_ip_2nd, dim_xy>
{
                   ...
                   const ip_coeff_t& gz, F EM, int m)
  {
    return (gy.vm * (gx.vm * EM(m, gx.l - 1, gy.l - 1, 0) +
            ...
            gy.v0 *
              (gx.vm * EM(m, gx.l - 1, gy.l, 0) + gx.v0 * EM(m, gx.l, gy.l, 0) +
...
struct InterpolateEM_Helper<F, IP, opt_ip_2nd, dim_xz>
{
                   ...
                   const ip_coeff_t& gz, F EM, int m)
  {
    return (gz.vm * (gx.vm * EM(m, gx.l - 1, 0, gz.l - 1) +
            ...
            gz.v0 *
              (gx.vm * EM(m, gx.l - 1, 0, gz.l) + gx.v0 * EM(m, gx.l, 0, gz.l) +
...
struct InterpolateEM_Helper<F, IP, opt_ip_2nd, dim_yz>
{
                   ...
                   const ip_coeff_t& gz, F EM, int m)
  {
    return (gz.vm * (gy.vm * EM(m, 0, gy.l - 1, gz.l - 1) +
            ...
            gz.v0 *
              (gy.vm * EM(m, 0, gy.l - 1, gz.l) + gy.v0 * EM(m, 0, gy.l, gz.l) +
