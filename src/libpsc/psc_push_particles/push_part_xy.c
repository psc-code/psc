...
static void
do_genc_push_part_xy(int p, fields_t *pf, particles_t *pp)
{
...
void
psc_push_particles_generic_c_push_xy(struct psc_push_particles *push,
				     ...
				     mfields_base_t *flds_base)
{
  ...
  psc_foreach_patch(ppsc, p) {
    do_genc_push_part_xy(p, psc_mfields_get_patch(flds, p), &particles->p[p]);
  }
  prof_stop(pr);
