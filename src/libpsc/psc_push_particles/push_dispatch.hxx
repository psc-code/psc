...
struct PushParticlesGenericC : PushParticlesBase
{
  ...
  void push_mprts_xy(MparticlesBase& mprts, PscMfieldsBase mflds) override
  ...
  void push_mprts_y(MparticlesBase& mprts, PscMfieldsBase mflds) override
  { return PushGenericC<dim_y>::push_mprts(mprts, mflds); }

  void push_mprts_z(MparticlesBase& mprts, PscMfieldsBase mflds) override
