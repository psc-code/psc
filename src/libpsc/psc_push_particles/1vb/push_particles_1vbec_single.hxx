...
using push_p_ops_1vbec_single_ = push_p_ops<push_p_config<mparticles_single_t, mfields_single_t, dim_t, opt_order_1st, opt_calcj_1vb_var1>>;
...
struct PushParticles1vbecSingle : PushParticles_<push_p_ops_1vbec_single_>
{
  ...
  {
    push_p_ops<push_p_config<mparticles_single_t, mfields_single_t, dim_xyz, opt_order_1st, opt_calcj_1vb_split>>::push_mprts(nullptr, mprts, mflds_base);
  }
