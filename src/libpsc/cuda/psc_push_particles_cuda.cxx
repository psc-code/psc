...
#define MAKE_1VBEC3D_YZ(MP_BS, CURRMEM_GLOBAL, MEM)			\
									\
  /* =============================================================== */ \
  /* psc_push_particles: subclass "1vbec3d_BYxBZ_MEM_cuda"    	     */	\
  									\
  static void								\
  psc_push_particles_1vbec3d ##MEM## _cuda_push_mprts_yz		\
  ...
  struct psc_push_particles_ops_1vbec3d ##MEM## _cuda :			\
    ...
    psc_push_particles_ops_1vbec3d ##MEM## _cuda() {			\
      ...
      push_mprts_yz         = psc_push_particles_1vbec3d ##MEM## _cuda_push_mprts_yz; \
      mp_flags              = MP_BS;					\
    }									\
  } psc_push_particles_1vbec3d ##MEM## _cuda_ops;


MAKE_1VBEC3D_YZ(MP_BLOCKSIZE_4X4X4, false, );
MAKE_1VBEC3D_YZ(MP_BLOCKSIZE_4X4X4, true, _gmem);
