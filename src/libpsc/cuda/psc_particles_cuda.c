...
// ----------------------------------------------------------------------
// psc_mparticles_cuda_reserve

static void
psc_mparticles_cuda_reserve(struct psc_mparticles *mprts, int *_n_prts_by_patch)
{
  struct psc_mparticles_cuda *mprts_cuda = psc_mparticles_cuda(mprts);
  struct cuda_mparticles *cmprts = mprts_cuda->cmprts;
...
psc_mparticles_cuda_read(struct psc_mparticles *mprts, struct mrc_io *io)
{
  ...
  psc_mparticles_reserve(mprts, n_prts_by_patch);
...
// ----------------------------------------------------------------------
// psc_mparticles_cuda_patch_resize

static void
psc_mparticles_cuda_patch_resize(struct psc_mparticles *mprts, int p, int n_prts)
{
  struct psc_mparticles_cuda *mprts_cuda = psc_mparticles_cuda(mprts);
...
struct psc_mparticles_ops psc_mparticles_cuda_ops = {
  ...
  .reserve                 = psc_mparticles_cuda_reserve,
  .get_nr_particles        = psc_mparticles_cuda_get_nr_particles,
  .patch_resize            = psc_mparticles_cuda_patch_resize,
