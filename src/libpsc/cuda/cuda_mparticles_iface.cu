...
cuda_mparticles_iface<BS>::CudaMparticles* cuda_mparticles_iface<BS>::new_(
  const Grid_t& grid)
{
  dprintf("CMPRTS: new\n");
...
template <typename BS>
std::vector<uint> cuda_mparticles_iface<BS>::sizeByPatch(
  const CudaMparticles* cmprts)
{
...
template <typename BS>
void cuda_mparticles_iface<BS>::inject(
  CudaMparticles* cmprts,
  const std::vector<cuda_mparticles_iface<BS>::Particle>& buf,
...
template <typename BS>
std::vector<uint> cuda_mparticles_iface<BS>::get_offsets(
  const CudaMparticles* cmprts)
{
...
template <typename BS>
std::vector<typename cuda_mparticles_iface<BS>::Particle>
cuda_mparticles_iface<BS>::get_particles(const CudaMparticles* cmprts)
{
...
template <typename BS>
cuda_mparticles_iface<BS>::Particle cuda_mparticles_iface<BS>::get_particle(
  const CudaMparticles* cmprts, int p, int n)
{
...
template <typename BS>
void cuda_mparticles_iface<BS>::dump(const CudaMparticles* cmprts,
