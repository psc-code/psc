...
push_yz(struct psc_push_particles *push,
	mparticles_base_t *particles_base,
	mfields_base_t *flds_base)
{
...
static void __unused
push_yz2(struct psc_push_particles *push,
	 mparticles_base_t *particles_base,
	 mfields_base_t *flds_base)
{
  cuda_push_part(particles_base, flds_base,
...
static void __unused
push_yz3(struct psc_push_particles *push,
	 mparticles_base_t *particles_base,
	 mfields_base_t *flds_base)
{
  cuda_push_part(particles_base, flds_base,
...
psc_push_particles_cuda_push_yz(struct psc_push_particles *push,
				...
				mfields_base_t *flds_base)
{
  push_yz3(push, particles_base, flds_base);
}
