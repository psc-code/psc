...
#define MAKE_1VBEC3D_YZ(BY, BZ, MP_BS)					\
									\
  /* =============================================================== */ \
  /* psc_push_particles: subclass "1vbec3d_2x2_cuda"	     	     */	\
  									\
  static void								\
  psc_push_particles_1vbec3d_##BY##x##BZ##_cuda_push_mprts_yz		\
  ...
  yz##BY##x##BZ##_1vbec3d_cuda_push_mprts(mprts, mflds);		\
  psc_mfields_put_as(mflds, mflds_base, JXI, JXI + 3);			\
  }									\
									\
  /* --------------------------------------------------------------- */	\
  ...
  psc_push_particles_1vbec3d_##BY##x##BZ##_cuda_ops = {			\
    .name                  = "1vbec3d_" #BY "x" #BZ "_cuda",		\
    .push_mprts_yz         = psc_push_particles_1vbec3d_ ##BY## x ##BZ## _cuda_push_mprts_yz,	\
