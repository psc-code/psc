...
void cuda_mparticles<BS>::reorder_and_offsets_slow()
{
  ...
  thrust::copy(h_alt_storage.xi4.begin(), h_alt_storage.xi4.end(),
               alt_storage.xi4.begin());
  thrust::copy(h_alt_storage.pxi4.begin(), h_alt_storage.pxi4.end(),
               alt_storage.pxi4.begin());
