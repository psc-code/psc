...
TEST_F(CudaMparticlesTest, CudaCollision)
{
  ...
  std::vector<cuda_mparticles_prt> prts = {
    {{.5, 75., 15.}, {1.0, 0., 0.}, 1., 0, true},
    {{.5, 75., 15.}, {1.1, 0., 0.}, 1., 0, true},
    {{.5, 75., 15.}, {1.2, 0., 0.}, 1., 0, true},
    {{.5, 35.,  5.}, {0., 1.0, 0.}, 1., 0, true},
    {{.5, 35.,  5.}, {0., 1.1, 0.}, 1., 0, true},
    {{.5, 35.,  5.}, {0., 1.2, 0.}, 1., 0, true},
    {{.5, 35.,  5.}, {0., 1.3, 0.}, 1., 0, true},
    {{.5, 35.,  5.}, {0., 1.4, 0.}, 1., 0, true},
    {{.5,  5.,  5.}, {0., 0., 1.0}, 1., 0, true},
    {{.5,  5.,  5.}, {0., 0., 1.1}, 1., 0, true},
  };
  uint n_prts_by_patch[1];
  n_prts_by_patch[0] = prts.size();
