...
void cuda_bndp<BS, DIM>::reorder_send_by_id(cuda_mparticles* cmprts, uint n_prts_send)
{
...
template<typename BS, typename DIM>
void cuda_bndp<BS, DIM>::reorder_send_by_id_gold(cuda_mparticles *cmprts, uint n_prts_send)
{
...
template<typename BS, typename DIM>
void cuda_bndp<BS, DIM>::reorder_send_buf_total(cuda_mparticles *cmprts, uint n_prts_send)
{
  if (n_patches == 0) {
    return;
  }
...
template<typename BS, typename DIM>
void cuda_bndp<BS, DIM>::scan_send_buf_total(cuda_mparticles* cmprts, uint n_prts_send)
{
...
template<typename BS, typename DIM>
void cuda_bndp<BS, DIM>::scan_send_buf_total_gold(cuda_mparticles *cmprts, uint n_prts_send)
{
