...
static inline void
calc_vxi(particle_single_by_block_real_t vxi[3], particle_single_by_block_t *part)
{
...
static void
psc_particles_single_by_block_copy_to_c(struct psc_particles *prts_base,
			       struct psc_particles *prts_c, unsigned int flags)
{
  ...
  for (int n = 0; n < prts_base->n_part; n++) {
    particle_single_by_block_t *part_base = particles_single_by_block_get_one(prts_base, n);
...
static void
psc_particles_single_by_block_copy_from_c(struct psc_particles *prts_base,
				 struct psc_particles *prts_c, unsigned int flags)
{
  particle_single_by_block_real_t dth[3] = { .5 * ppsc->dt, .5 * ppsc->dt, .5 * ppsc->dt };
  // don't shift in invariant directions
  ...
  struct psc_particles_single_by_block *sub = psc_particles_single_by_block(prts_base);
...
static struct mrc_obj_method psc_particles_single_by_block_methods[] = {
  MRC_OBJ_METHOD("copy_to_c"       , psc_particles_single_by_block_copy_to_c),
  MRC_OBJ_METHOD("copy_from_c"     , psc_particles_single_by_block_copy_from_c),
  {}
};
