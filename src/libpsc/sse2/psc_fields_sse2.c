...
void
psc_mfields_sse2_get(fields_sse2_t *pf, int mb, int me)
{
  *pf = psc.pf;
}

void
psc_mfields_sse2_put(fields_sse2_t *pf, int mb, int me)
{
  pf->flds = NULL;
}
...
void
psc_mfields_sse2_get(fields_sse2_t *pf, int mb, int me, void *_flds_base)
{
  assert(!__gotten);
  __gotten = true;
...
void
psc_mfields_sse2_put(fields_sse2_t *pf, int mb, int me, void *_flds_base)
{
  assert(__gotten);
  __gotten = false;
