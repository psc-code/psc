...
static void psc_push_fields_acc_push_mflds_E(struct psc_push_fields* push,
                                             struct psc_mfields* mflds_base)
{
  struct psc_mfields* mflds =
    psc_mfields_get_as(mflds_base, "acc", JXI, HX + 3);
...
static void psc_push_fields_acc_push_mflds_H(struct psc_push_fields* push,
                                             struct psc_mfields* mflds_base)
{
