...
static void psc_push_particles_1vbec_push_mprts_yz(
  struct psc_push_particles* push, struct psc_mparticles* mprts_base,
  struct psc_mfields* mflds_base)
{
  ...
  struct psc_mparticles* mprts = psc_mparticles_get_as(mprts_base, "acc", 0);
  struct psc_mfields* mflds = psc_mfields_get_as(mflds_base, "acc", EX, EX + 6);
...
static void psc_push_particles_1vbec_push_mprts_xyz(
  struct psc_push_particles* push, struct psc_mparticles* mprts_base,
  struct psc_mfields* mflds_base)
{
  static int pr;
...
struct psc_push_particles_ops psc_push_particles_1vbec_acc_ops = {
  .name = "1vbec_acc",
