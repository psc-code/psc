...
struct psc_sort_ops_countsort_single : psc_sort_ops {
  psc_sort_ops_countsort_single() {
    ...
    size                  = sizeof(psc_sort_countsort<mparticles_single_t>);
    run                   = psc_sort_countsort<mparticles_single_t>::run;
  }
...
struct psc_sort_ops_countsort2_single : psc_sort_ops {
  psc_sort_ops_countsort2_single() {
    ...
    size                  = sizeof(psc_sort_countsort2<mparticles_single_t>);
    run                   = psc_sort_countsort2<mparticles_single_t>::run;
  }
...
struct psc_sort_ops_countsort_double : psc_sort_ops {
  psc_sort_ops_countsort_double() {
    ...
    size                  = sizeof(psc_sort_countsort<mparticles_double_t>);
    run                   = psc_sort_countsort<mparticles_double_t>::run;
  }
...
struct psc_sort_ops_countsort2_double : psc_sort_ops {
  psc_sort_ops_countsort2_double() {
    ...
    size                  = sizeof(psc_sort_countsort2<mparticles_double_t>);
    run                   = psc_sort_countsort2<mparticles_double_t>::run;
  }
