...
void psc_stats_log(int timestep)
{
  ...
  double stats_min[nr_psc_stats], stats_max[nr_psc_stats],
    stats_sum[nr_psc_stats];
  MPI_Reduce(psc_stats_val, stats_min, nr_psc_stats, MPI_DOUBLE, MPI_MIN, 0,
             MPI_COMM_WORLD);
  MPI_Reduce(psc_stats_val, stats_max, nr_psc_stats, MPI_DOUBLE, MPI_MAX, 0,
             MPI_COMM_WORLD);
  MPI_Reduce(psc_stats_val, stats_sum, nr_psc_stats, MPI_DOUBLE, MPI_SUM, 0,
             MPI_COMM_WORLD);
