...
static void psc_mfields_fortran_copy_to_c(struct psc_mfields* mflds,
                                          struct psc_mfields* mflds_c, int mb,
                                          int me)
{
  mfields_t mf(mflds);
...
static void psc_mfields_fortran_copy_from_c(struct psc_mfields* mflds,
                                            struct psc_mfields* mflds_c, int mb,
                                            int me)
{
  mfields_t mf(mflds);
