...
void
psc_mfields_fortran_get(mfields_fortran_t *flds, int mb, int me, void *_flds_base)
{
...
void
psc_mfields_fortran_put(mfields_fortran_t *flds, int mb, int me, void *_flds_base)
{
}
