...
#define to_psc_output_photons_xdmf_compact(out) ((struct psc_output_photons_xdmf_compact *)((out)->obj.subctx))
...
static void create_master_xdmf(struct psc_output_photons_xdmf *out_c) {
...
void create_hdf5 (struct psc_output_photons_xdmf *out_c) {
...
psc_output_photons_xdmf_run(struct psc_output_photons *out, mphotons_t *photons) {
	static int pr;
  	...
  	if (out_c->write_photons[ppsc->timestep]) {
...
struct psc_output_photons_ops psc_output_photons_xdmf_compact_ops = {
  .name                  = "xdmf_compact",
