...
// ----------------------------------------------------------------------
// psc_event_generator_c_run

static void
psc_event_generator_c_run(struct psc_event_generator *gen,
...
// ======================================================================
// psc_event_generator: subclass "c"

struct psc_event_generator_ops psc_event_generator_c_ops = {
  .name                  = "c",
  .run                   = psc_event_generator_c_run,
};
