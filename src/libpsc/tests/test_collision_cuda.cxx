...
TEST(cuda_mparticles_randomize_sort, sort)
{
  ...
  // The result here depends on the particular random numbers generated, which seem
  // to have changed across CUDA versions, so we just check that the random indices
  // end up sorted.
  // EXPECT_EQ(
