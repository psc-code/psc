...
#
# Run Notes: Sound wave. Use pdim and mode_num to
...
# plot quick and dirty time series:
# viscid_ts --slice x=0,y=0,z=0 -p rr -p vx sound_x_512.3d.xdmf

# plot final time step:
# viscid_2d --own --slice z=0 -p rr -p vx -t -1 sound_x_512.3d.xdmf

# plot movie
# viscid_2d --own --slice z=0 -p rr -p vx -o lin_-1e-3_1e-3 \
#           -a sound_x_512.mp4 --np 2 sound_x_512.3d.xdmf
