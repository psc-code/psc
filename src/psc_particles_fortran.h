...
void particles_fortran_get(particles_fortran_t *pp, struct psc_mparticles *particles_base);
void particles_fortran_put(particles_fortran_t *pp, struct psc_mparticles *particles_base);
