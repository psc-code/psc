...
#define to_psc_test_singlepart(psc)                                            \
  mrc_to_subobj(psc, struct psc_test_singlepart)

// ----------------------------------------------------------------------
// psc_test_singlepart_create

static void psc_test_singlepart_create(struct psc* psc)
{
  psc->prm.nmax = 1000;
  psc->prm.lw = 1. * 1e-6;
  psc->prm.i0 = 2.0e22;
...
static void psc_test_singlepart_init_npt(struct psc* psc, int kind, double x[3],
