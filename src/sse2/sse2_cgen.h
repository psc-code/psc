...
#define INTERP_FIELD_YZ(F_ENUM, indx1, indx2, indx3, outer_coeff, inner_coeff, field) { \
  									\
    pvInt indx2##pls1, indx2##mns1, indx3##pls1, indx3##mns1;		\
    pvReal field##_in, field##tmp1, field##tmp2, field##tmp3;		\
									\
    indx2##pls1.r = pv_int_ADD(indx2.r, ione.r);			\
    indx2##mns1.r = pv_int_SUB(indx2.r, ione.r);			\
    indx3##pls1.r = pv_int_ADD(indx3.r, ione.r);		\
    indx3##mns1.r = pv_int_SUB(indx3.r, ione.r);			\
									\
    field##_in.v[0] = C_FIELD(F_ENUM, indx1.v[0], indx2##mns1.v[0],indx3##mns1.v[0]);	\
    field##_in.v[1] = C_FIELD(F_ENUM, indx1.v[1], indx2##mns1.v[1],indx3##mns1.v[1]);	\
    field##_in.v[2] = C_FIELD(F_ENUM, indx1.v[2], indx2##mns1.v[2],indx3##mns1.v[2]);	\
    field##_in.v[3] = C_FIELD(F_ENUM, indx1.v[3], indx2##mns1.v[3],indx3##mns1.v[3]);	\
    field##tmp1.r = pv_real_MUL(inner_coeff[0].r, field##_in.r);		\
									\
    field##_in.v[0] = C_FIELD(F_ENUM, indx1.v[0], indx2.v[0],indx3##mns1.v[0]); \
    field##_in.v[1] = C_FIELD(F_ENUM, indx1.v[1], indx2.v[1],indx3##mns1.v[1]); \
    field##_in.v[2] = C_FIELD(F_ENUM, indx1.v[2], indx2.v[2],indx3##mns1.v[2]); \
    field##_in.v[3] = C_FIELD(F_ENUM, indx1.v[3], indx2.v[3],indx3##mns1.v[3]); \
    field##tmp2.r = pv_real_MUL(inner_coeff[1].r, field##_in.r);		\
									\
    field##_in.v[0] = C_FIELD(F_ENUM, indx1.v[0], indx2##pls1.v[0],indx3##mns1.v[0]); \
    field##_in.v[1] = C_FIELD(F_ENUM, indx1.v[1], indx2##pls1.v[1],indx3##mns1.v[1]); \
    field##_in.v[2] = C_FIELD(F_ENUM, indx1.v[2], indx2##pls1.v[2],indx3##mns1.v[2]); \
    field##_in.v[3] = C_FIELD(F_ENUM, indx1.v[3], indx2##pls1.v[3],indx3##mns1.v[3]);	\
    field##tmp3.r = pv_real_MUL(inner_coeff[2].r, field##_in.r);		\
    									\
    field##tmp1.r = pv_real_ADD(field##tmp1.r, field##tmp2.r);		\
    field##tmp1.r = pv_real_ADD(field##tmp1.r, field##tmp3.r);		\
    field.r = pv_real_MUL(outer_coeff[0].r, field##tmp1.r);		\
    									\
    field##_in.v[0] = C_FIELD(F_ENUM, indx1.v[0], indx2##mns1.v[0],indx3.v[0]); \
    field##_in.v[1] = C_FIELD(F_ENUM, indx1.v[1], indx2##mns1.v[1],indx3.v[1]); \
    field##_in.v[2] = C_FIELD(F_ENUM, indx1.v[2], indx2##mns1.v[2],indx3.v[2]); \
    field##_in.v[3] = C_FIELD(F_ENUM, indx1.v[3], indx2##mns1.v[3],indx3.v[3]); \
    field##tmp1.r = pv_real_MUL(inner_coeff[0].r, field##_in.r);		\
    									\
    field##_in.v[0] = C_FIELD(F_ENUM, indx1.v[0], indx2.v[0],indx3.v[0]); \
    field##_in.v[1] = C_FIELD(F_ENUM, indx1.v[1], indx2.v[1],indx3.v[1]); \
    field##_in.v[2] = C_FIELD(F_ENUM, indx1.v[2], indx2.v[2],indx3.v[2]); \
    field##_in.v[3] = C_FIELD(F_ENUM, indx1.v[3], indx2.v[3],indx3.v[3]); \
    field##tmp2.r = pv_real_MUL(inner_coeff[1].r, field##_in.r);		\
    									\
    field##_in.v[0] = C_FIELD(F_ENUM, indx1.v[0], indx2##pls1.v[0],indx3.v[0]); \
    field##_in.v[1] = C_FIELD(F_ENUM, indx1.v[1], indx2##pls1.v[1],indx3.v[1]); \
    field##_in.v[2] = C_FIELD(F_ENUM, indx1.v[2], indx2##pls1.v[2],indx3.v[2]); \
    field##_in.v[3] = C_FIELD(F_ENUM, indx1.v[3], indx2##pls1.v[3],indx3.v[3]); \
    field##tmp3.r = pv_real_MUL(inner_coeff[2].r, field##_in.r);		\
    									\
    field##tmp1.r = pv_real_ADD(field##tmp1.r, field##tmp2.r);		\
    field##tmp1.r = pv_real_ADD(field##tmp1.r, field##tmp3.r);		\
    field##tmp1.r = pv_real_MUL(outer_coeff[1].r, field##tmp1.r);	\
    field.r = pv_real_ADD(field.r, field##tmp1.r);			\
    									\
    field##_in.v[0] = C_FIELD(F_ENUM, indx1.v[0], indx2##mns1.v[0],indx3##pls1.v[0]); \
    field##_in.v[1] = C_FIELD(F_ENUM, indx1.v[1], indx2##mns1.v[1],indx3##pls1.v[1]); \
    field##_in.v[2] = C_FIELD(F_ENUM, indx1.v[2], indx2##mns1.v[2],indx3##pls1.v[2]); \
    field##_in.v[3] = C_FIELD(F_ENUM, indx1.v[3], indx2##mns1.v[3],indx3##pls1.v[3]);	\
    field##tmp1.r = pv_real_MUL(inner_coeff[0].r, field##_in.r);		\
    									\
    field##_in.v[0] = C_FIELD(F_ENUM, indx1.v[0], indx2.v[0],indx3##pls1.v[0]); \
    field##_in.v[1] = C_FIELD(F_ENUM, indx1.v[1], indx2.v[1],indx3##pls1.v[1]); \
    field##_in.v[2] = C_FIELD(F_ENUM, indx1.v[2], indx2.v[2],indx3##pls1.v[2]); \
    field##_in.v[3] = C_FIELD(F_ENUM, indx1.v[3], indx2.v[3],indx3##pls1.v[3]); \
    field##tmp2.r = pv_real_MUL(inner_coeff[1].r, field##_in.r);		\
    									\
    field##_in.v[0] = C_FIELD(F_ENUM, indx1.v[0], indx2##pls1.v[0],indx3##pls1.v[0]); \
    field##_in.v[1] = C_FIELD(F_ENUM, indx1.v[1], indx2##pls1.v[1],indx3##pls1.v[1]); \
    field##_in.v[2] = C_FIELD(F_ENUM, indx1.v[2], indx2##pls1.v[2],indx3##pls1.v[2]); \
    field##_in.v[3] = C_FIELD(F_ENUM, indx1.v[3], indx2##pls1.v[3],indx3##pls1.v[3]);	\
    field##tmp3.r = pv_real_MUL(inner_coeff[2].r, field##_in.r);		\
    									\
    field##tmp1.r = pv_real_ADD(field##tmp1.r, field##tmp2.r);		\
    field##tmp1.r = pv_real_ADD(field##tmp1.r, field##tmp3.r);		\
    field##tmp1.r = pv_real_MUL(outer_coeff[2].r, field##tmp1.r);	\
    field.r = pv_real_ADD(field.r, field##tmp1.r);			\
  }
