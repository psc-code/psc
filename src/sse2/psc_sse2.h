...
void sse2_push_part_yz_a(struct psc_mfields *flds_base, struct psc_mparticles *particles_base);
void sse2_push_part_yz_b(struct psc_mfields *flds_base, struct psc_mparticles *particles_base);
void sse2_push_part_yz(struct psc_mfields *flds_base, struct psc_mparticles *particles_base);
