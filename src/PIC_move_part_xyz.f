...
c DETERMINE THE DENSITIES AT t=(n+1.0)*dt
            ...
            if (qni.lt.0.0) then
               fnq=qni*wni*fnqs
               ne(l1-1,l2-1,l3-1)=ne(l1-1,l2-1,l3-1)+fnq*gmx*gmy*gmz
               ne(l1,l2-1,l3-1)=ne(l1,l2-1,l3-1)+fnq*g0x*gmy*gmz
               ne(l1+1,l2-1,l3-1)=ne(l1+1,l2-1,l3-1)+fnq*g1x*gmy*gmz
               ne(l1-1,l2,l3-1)=ne(l1-1,l2,l3-1)+fnq*gmx*g0y*gmz
               ne(l1,l2,l3-1)=ne(l1,l2,l3-1)+fnq*g0x*g0y*gmz
               ne(l1+1,l2,l3-1)=ne(l1+1,l2,l3-1)+fnq*g1x*g0y*gmz
               ne(l1-1,l2+1,l3-1)=ne(l1-1,l2+1,l3-1)+fnq*gmx*g1y*gmz
               ne(l1,l2+1,l3-1)=ne(l1,l2+1,l3-1)+fnq*g0x*g1y*gmz
               ne(l1+1,l2+1,l3-1)=ne(l1+1,l2+1,l3-1)+fnq*g1x*g1y*gmz
               ne(l1-1,l2-1,l3)=ne(l1-1,l2-1,l3)+fnq*gmx*gmy*g0z
               ne(l1,l2-1,l3)=ne(l1,l2-1,l3)+fnq*g0x*gmy*g0z
               ne(l1+1,l2-1,l3)=ne(l1+1,l2-1,l3)+fnq*g1x*gmy*g0z
               ne(l1-1,l2,l3)=ne(l1-1,l2,l3)+fnq*gmx*g0y*g0z
               ne(l1,l2,l3)=ne(l1,l2,l3)+fnq*g0x*g0y*g0z
               ne(l1+1,l2,l3)=ne(l1+1,l2,l3)+fnq*g1x*g0y*g0z
               ne(l1-1,l2+1,l3)=ne(l1-1,l2+1,l3)+fnq*gmx*g1y*g0z
               ne(l1,l2+1,l3)=ne(l1,l2+1,l3)+fnq*g0x*g1y*g0z
               ne(l1+1,l2+1,l3)=ne(l1+1,l2+1,l3)+fnq*g1x*g1y*g0z
               ne(l1-1,l2-1,l3+1)=ne(l1-1,l2-1,l3+1)+fnq*gmx*gmy*g1z
               ne(l1,l2-1,l3+1)=ne(l1,l2-1,l3+1)+fnq*g0x*gmy*g1z
               ne(l1+1,l2-1,l3+1)=ne(l1+1,l2-1,l3+1)+fnq*g1x*gmy*g1z
               ne(l1-1,l2,l3+1)=ne(l1-1,l2,l3+1)+fnq*gmx*g0y*g1z
               ne(l1,l2,l3+1)=ne(l1,l2,l3+1)+fnq*g0x*g0y*g1z
               ne(l1+1,l2,l3+1)=ne(l1+1,l2,l3+1)+fnq*g1x*g0y*g1z
               ne(l1-1,l2+1,l3+1)=ne(l1-1,l2+1,l3+1)+fnq*gmx*g1y*g1z
               ne(l1,l2+1,l3+1)=ne(l1,l2+1,l3+1)+fnq*g0x*g1y*g1z
               ne(l1+1,l2+1,l3+1)=ne(l1+1,l2+1,l3+1)+fnq*g1x*g1y*g1z
            else if (qni.gt.0.0) then
               fnq=qni*wni*fnqs
               ni(l1-1,l2-1,l3-1)=ni(l1-1,l2-1,l3-1)+fnq*gmx*gmy*gmz
               ni(l1,l2-1,l3-1)=ni(l1,l2-1,l3-1)+fnq*g0x*gmy*gmz
               ni(l1+1,l2-1,l3-1)=ni(l1+1,l2-1,l3-1)+fnq*g1x*gmy*gmz
               ni(l1-1,l2,l3-1)=ni(l1-1,l2,l3-1)+fnq*gmx*g0y*gmz
               ni(l1,l2,l3-1)=ni(l1,l2,l3-1)+fnq*g0x*g0y*gmz
               ni(l1+1,l2,l3-1)=ni(l1+1,l2,l3-1)+fnq*g1x*g0y*gmz
               ni(l1-1,l2+1,l3-1)=ni(l1-1,l2+1,l3-1)+fnq*gmx*g1y*gmz
               ni(l1,l2+1,l3-1)=ni(l1,l2+1,l3-1)+fnq*g0x*g1y*gmz
               ni(l1+1,l2+1,l3-1)=ni(l1+1,l2+1,l3-1)+fnq*g1x*g1y*gmz
               ni(l1-1,l2-1,l3)=ni(l1-1,l2-1,l3)+fnq*gmx*gmy*g0z
               ni(l1,l2-1,l3)=ni(l1,l2-1,l3)+fnq*g0x*gmy*g0z
               ni(l1+1,l2-1,l3)=ni(l1+1,l2-1,l3)+fnq*g1x*gmy*g0z
               ni(l1-1,l2,l3)=ni(l1-1,l2,l3)+fnq*gmx*g0y*g0z
               ni(l1,l2,l3)=ni(l1,l2,l3)+fnq*g0x*g0y*g0z
               ni(l1+1,l2,l3)=ni(l1+1,l2,l3)+fnq*g1x*g0y*g0z
               ni(l1-1,l2+1,l3)=ni(l1-1,l2+1,l3)+fnq*gmx*g1y*g0z
               ni(l1,l2+1,l3)=ni(l1,l2+1,l3)+fnq*g0x*g1y*g0z
               ni(l1+1,l2+1,l3)=ni(l1+1,l2+1,l3)+fnq*g1x*g1y*g0z
               ni(l1-1,l2-1,l3+1)=ni(l1-1,l2-1,l3+1)+fnq*gmx*gmy*g1z
               ni(l1,l2-1,l3+1)=ni(l1,l2-1,l3+1)+fnq*g0x*gmy*g1z
               ni(l1+1,l2-1,l3+1)=ni(l1+1,l2-1,l3+1)+fnq*g1x*gmy*g1z
               ni(l1-1,l2,l3+1)=ni(l1-1,l2,l3+1)+fnq*gmx*g0y*g1z
               ni(l1,l2,l3+1)=ni(l1,l2,l3+1)+fnq*g0x*g0y*g1z
               ni(l1+1,l2,l3+1)=ni(l1+1,l2,l3+1)+fnq*g1x*g0y*g1z
               ni(l1-1,l2+1,l3+1)=ni(l1-1,l2+1,l3+1)+fnq*gmx*g1y*g1z
               ni(l1,l2+1,l3+1)=ni(l1,l2+1,l3+1)+fnq*g0x*g1y*g1z
               ni(l1+1,l2+1,l3+1)=ni(l1+1,l2+1,l3+1)+fnq*g1x*g1y*g1z
            else if (qni.eq.0.0) then
               fnq=wni*fnqs
               nn(l1-1,l2-1,l3-1)=nn(l1-1,l2-1,l3-1)+fnq*gmx*gmy*gmz
               nn(l1,l2-1,l3-1)=nn(l1,l2-1,l3-1)+fnq*g0x*gmy*gmz
               nn(l1+1,l2-1,l3-1)=nn(l1+1,l2-1,l3-1)+fnq*g1x*gmy*gmz
               nn(l1-1,l2,l3-1)=nn(l1-1,l2,l3-1)+fnq*gmx*g0y*gmz
               nn(l1,l2,l3-1)=nn(l1,l2,l3-1)+fnq*g0x*g0y*gmz
               nn(l1+1,l2,l3-1)=nn(l1+1,l2,l3-1)+fnq*g1x*g0y*gmz
               nn(l1-1,l2+1,l3-1)=nn(l1-1,l2+1,l3-1)+fnq*gmx*g1y*gmz
               nn(l1,l2+1,l3-1)=nn(l1,l2+1,l3-1)+fnq*g0x*g1y*gmz
               nn(l1+1,l2+1,l3-1)=nn(l1+1,l2+1,l3-1)+fnq*g1x*g1y*gmz
               nn(l1-1,l2-1,l3)=nn(l1-1,l2-1,l3)+fnq*gmx*gmy*g0z
               nn(l1,l2-1,l3)=nn(l1,l2-1,l3)+fnq*g0x*gmy*g0z
               nn(l1+1,l2-1,l3)=nn(l1+1,l2-1,l3)+fnq*g1x*gmy*g0z
               nn(l1-1,l2,l3)=nn(l1-1,l2,l3)+fnq*gmx*g0y*g0z
               nn(l1,l2,l3)=nn(l1,l2,l3)+fnq*g0x*g0y*g0z
               nn(l1+1,l2,l3)=nn(l1+1,l2,l3)+fnq*g1x*g0y*g0z
               nn(l1-1,l2+1,l3)=nn(l1-1,l2+1,l3)+fnq*gmx*g1y*g0z
               nn(l1,l2+1,l3)=nn(l1,l2+1,l3)+fnq*g0x*g1y*g0z
               nn(l1+1,l2+1,l3)=nn(l1+1,l2+1,l3)+fnq*g1x*g1y*g0z
               nn(l1-1,l2-1,l3+1)=nn(l1-1,l2-1,l3+1)+fnq*gmx*gmy*g1z
               nn(l1,l2-1,l3+1)=nn(l1,l2-1,l3+1)+fnq*g0x*gmy*g1z
               nn(l1+1,l2-1,l3+1)=nn(l1+1,l2-1,l3+1)+fnq*g1x*gmy*g1z
               nn(l1-1,l2,l3+1)=nn(l1-1,l2,l3+1)+fnq*gmx*g0y*g1z
               nn(l1,l2,l3+1)=nn(l1,l2,l3+1)+fnq*g0x*g0y*g1z
               nn(l1+1,l2,l3+1)=nn(l1+1,l2,l3+1)+fnq*g1x*g0y*g1z
               nn(l1-1,l2+1,l3+1)=nn(l1-1,l2+1,l3+1)+fnq*gmx*g1y*g1z
               nn(l1,l2+1,l3+1)=nn(l1,l2+1,l3+1)+fnq*g0x*g1y*g1z
               nn(l1+1,l2+1,l3+1)=nn(l1+1,l2+1,l3+1)+fnq*g1x*g1y*g1z
            endif
...
c CURRENT DENSITY AT (n+1.0)*dt
     ...
     &                                      +jzh(l1,l2,l3)
      ...
      end subroutine PIC_move_part_xyz
