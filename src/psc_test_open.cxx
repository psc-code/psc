...
static void psc_test_open_create(struct psc* psc)
{
...
static void psc_test_open_setup(struct psc* psc)
{
...
static double psc_test_open_init_field(struct psc* psc, double x[3], int m)
{
  //  struct psc_test_open *sub = to_psc_test_open(psc);
...
static void psc_test_open_init_npt(struct psc* psc, int pop, double x[3],
