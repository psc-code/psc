...
void mrc_obj_get_param_float(struct mrc_obj *obj, const char *name, float *pval);
...
struct mrc_obj *mrc_obj_get_param_obj(struct mrc_obj *obj, const char *name);
...
#define MRC_CLASS_DECLARE(pfx, obj_type)				\
  ...
  {									\
    mrc_obj_get_param_bool((struct mrc_obj *)obj, name, pval);		\
  }									\
									\
  static inline void 							\
  ...
  {									\
    mrc_obj_get_param_float((struct mrc_obj *)obj, name, pval);		\
  }									\
									\
  static inline void 							\
  ...
  {									\
    mrc_obj_get_param_float3((struct mrc_obj *)obj, name, pval);	\
  }									\
									\
  static inline void 							\
  ...
  {									\
    mrc_obj_get_param_double3((struct mrc_obj *)obj, name, pval);	\
									...
									\
  static inline void *							\
  pfx ## _get_param_obj(obj_type *obj, const char *name)		\
  {									\
