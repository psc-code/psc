...
struct mrc_f3 *mrc_domain_f3_create(struct mrc_domain *domain, int sw, const char *comps);
...
struct mrc_fld *mrc_domain_fld_create(struct mrc_domain *domain, int sw, int nr_comps);
